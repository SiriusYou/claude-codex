...
| 文档 | 描述 | 适用人群 |
|------|------|----------|
| [README-zh.md](README-zh.md) | 主要使用指南 | 所有用户 |
| [README-config-zh.md](README-config-zh.md) | 配置文件详细说明 | 需要自定义配置的用户 |
| [troubleshooting-zh.md](troubleshooting-zh.md) | 故障排除指南 | 遇到问题的用户 |
...
2. **查看**: [troubleshooting-zh.md](troubleshooting-zh.md) 故障排除指南
